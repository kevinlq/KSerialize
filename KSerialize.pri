!isEmpty(KSERIALIZE_PRI_INCLUDED) {
    error("KSerialize.pri already included")
}
KSERIALIZE_PRI_INCLUDED = 1

KSERIALIZE_VERSION_STR = 0.0.1
KSERIALIZE_VERSION = 0x000001
VERSION = $$KSERIALIZE_VERSION_STR
KSERIALIZE_COPYRIGHT_YEAR = 2023
...
IDE_APP_NAME = KSERIALIZE
IDE_APP_PATH = $$PWD/bin
KSERIALIZE_PREFIX = $$IDE_APP_PATH/$$DIR_PLATFORM/$$DIR_COMPILER/$$DIR_COMPILEMODE
IDE_BIN_PATH     = $$KSERIALIZE_PREFIX
IDE_LIBRARY_PATH = $$KSERIALIZE_PREFIX
IDE_PLUGIN_PATH  = $$KSERIALIZE_PREFIX/plugins
IDE_DOC_PATH     = $$KSERIALIZE_PREFIX/share/doc
IDE_DATA_PATH    = $$KSERIALIZE_PREFIX/share/$$IDE_APP_NAME
...
KSERIALIZE_PATH_INFO = 0
equals(KSERIALIZE_PATH_INFO, 1) {
message("=================PATH info =============================")
