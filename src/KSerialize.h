...
class KSERIALIZE_EXPORT KSerialize : public QObject , public SerializationHelper
{
    Q_OBJECT
public:
...
protected:
    ...
    QVariant serializeSubtype(int propertyType, const QVariant &value, const QByteArray &traceHint = {}) const override;
