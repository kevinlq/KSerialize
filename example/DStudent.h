...
class sObj : public QObject
{
    Q_OBJECT
    Q_PROPERTY(QList<float> testFloatList MEMBER testFloatList)
public:
    Q_INVOKABLE sObj(QObject *parent = nullptr) : QObject(parent){}
...
class DScore : public QObject
{
    ...
    Q_PROPERTY(QList<float> testFloatList MEMBER testFloatList)
    Q_PROPERTY(QList<double> testDoubleList MEMBER testDoubleList)
public:
    Q_INVOKABLE explicit DScore(QObject *parent = nullptr);
