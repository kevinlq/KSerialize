...
int main(/*int argc, char *argv[]*/)
{
    ...
    score->testDoubleList = {10.1, 20.2, 30.3, 40.4, 50.5};
    ...
    qDebug() << "testDoubleList:" << deserScore->testDoubleList;
...
#endif
    auto obj = new sObj;
    obj->testFloatList = {1.1f, 2.2f, 3.3f, 4.4f, 5.5f};
    auto json = serial.serialize(obj);
    qDebug() << "score:" << JSON_PRINT(json.toObject());
